                ...
                <nav class="main-navigation">
                    <ul class="main-navigation__list">
                        ...
                        <li class="main-navigation__list-item">
                            <a class="main-navigation__list-item-link <?php if (isset($_GET['progect_id']) && $progect_id === $progect["progect_id"]): ?>main-navigation__list-item--active<?php endif ?>" href="/index.php?progect_id=<?=$progect["progect_id"]?>"><?=htmlspecialchars($item["progect_name"]);?></a>
                            <span class="main-navigation__list-item-count"><?=$task_list, $progect["progect_id"];?></span>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                </nav>
